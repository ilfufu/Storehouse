### 项目说明
基于学习，复现并改进的一个前后端分离的后台管理系统项目，前端使用Vue框架，后端使用SpringBoot框架，数据库使用MySQL，<a href="http://47.110.234.156:80">目前由此可以从公网上访问已运行起来的项目</a>
...
### 待实现功能
暂时租用阿里云服务器部署了项目，公网可以访问，后面不租借了可能会把公网的部署撤销掉
